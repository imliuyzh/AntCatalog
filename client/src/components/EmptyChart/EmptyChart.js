    ...
    return (
        <EmptyState variant={EmptyStateVariant.xl}>
            ...
            <EmptyStateBody>
                ...
                significant efforts on data cleaning. The range of data begins from Fall 2013 and ends at Fall 2022 (Summer sessions are excluded).
                I will attempt to update the statistics once every quarter. In order to get this data, I must make a request to UCI's Public Records
                Office (PRO). Sometimes, you may not find the data for a particular course due to a variety of circumstances such as late grade submittal.
                If this happens, please contact me through GitHub issues.
